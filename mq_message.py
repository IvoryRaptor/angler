...
from protobuf3.fields import BytesField, MessageField, Int64Field, StringField
...
SkinPayload.add_field('matrix', StringField(field_number=1, optional=True))
SkinPayload.add_field('angler', StringField(field_number=2, optional=True))
SkinPayload.add_field('number', StringField(field_number=3, optional=True))
SkinPayload.add_field('time', Int64Field(field_number=4, optional=True))
