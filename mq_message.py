...
MintPayload.add_field('matrix', StringField(field_number=1, optional=True))
MintPayload.add_field('angler', StringField(field_number=2, optional=True))
MintPayload.add_field('number', StringField(field_number=3, optional=True))
MintPayload.add_field('time', Int64Field(field_number=4, optional=True))
